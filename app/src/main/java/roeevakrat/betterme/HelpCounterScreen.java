...
public class HelpCounterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText = (TextView)findViewById(R.id.helpTitle);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent counterScreenIntent = new Intent(HelpCounterScreen.this, CounterScreen.class);
